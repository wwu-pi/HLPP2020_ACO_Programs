...
double run_aco_bpp(int NANT, int INTER, int problem, int is_palma);
...
__global__ void packing_kernel(double*	d_n_objects,double* d_n_objects_total, double* d_bins_capacity, int* d_n_ants, double* d_phero, double*  d_bpp_items,
		double*  d_bpp_items_copy, int* d_bins, double*  eta, double*  tau, double*  probs, double* d_fitness, curandState* rand_states);
